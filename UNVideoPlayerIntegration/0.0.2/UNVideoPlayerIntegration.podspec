...
s.source_files = 'UNVideoPlayerIntegration/Pod/Classes/**/*.{m,h}', 'UNVideoPlayerIntegration/Pod/Headers/Public/*.h'
...
s.public_header_files = 'UNVideoPlayerIntegration/Pod/Headers/Public/*.h'
s.private_header_files = 'UNVideoPlayerIntegration/Pod/Headers/Private/*.h'
