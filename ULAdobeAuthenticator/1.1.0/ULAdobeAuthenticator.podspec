Pod::Spec.new do |s|
  ...
  s.subspec 'ULAdobeAuthenticator' do |ula|
    ...
    # Public header files
    ula.public_header_files = 'ULAdobeAuthenticator/Pod/Classes/ULAdobeAuthenticator/ULAdobeAuthenticator.h', 'ULAdobeAuthenticator/Pod/Classes/ULAdobeAuthenticator/ULAAuthenticationManager.h', 'ULAdobeAuthenticator/Pod/Classes/ULAdobeAuthenticator/ULALoginDelegate.h', 'ULAdobeAuthenticator/Pod/Classes/ULAdobeAuthenticator/ULAProvider.h','ULAdobeAuthenticator/Pod/Classes/ULAdobeAuthenticator/ULALoginViewController.h', 'ULAdobeAuthenticator/Pod/Classes/ULAdobeAuthenticator/ULMVPDWhiteListModel.h'

    # Dependency 
    ula.dependency 'ULAdobeAuthenticator/AccessEnabler' 
    ula.dependency 'ULAnalyticsManager/Signals', '~> 1.0.0'
  end
