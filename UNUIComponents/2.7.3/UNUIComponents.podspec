Pod::Spec.new do |s|
  ...
  s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"${PODS_ROOT}/TwitterCore/iOS" "${PODS_ROOT}/TwitterKit"', 'GCC_PREPROCESSOR_DEFINITIONS' => 'COMSCORE_ON=0 NIELSEN_ON=0' }
...
# Univision
  s.dependency 'UNFeedSyn', '0.0.69'
  s.dependency 'UNVideoPlayer', '0.6.9'
...
# 3rd Party
  ...
  s.dependency 'UrbanAirship-iOS-SDK', '8.0.0'
