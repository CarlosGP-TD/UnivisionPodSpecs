...
s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"${PODS_ROOT}/TwitterCore/iOS" "${PODS_ROOT}/TwitterKit"', 'GCC_PREPROCESSOR_DEFINITIONS' => 'COMSCORE_ON=1 NIELSEN_ON=1' }
s.preserve_paths = 'UNUIComponents/Pod/**/*.{framework,a}'
s.vendored_frameworks = 'UNUIComponents/Pod/Frameworks/TealiumLibrary.framework', 'UNUIComponents/Pod/Frameworks/BuddyBuildSDK.framework', 'UNUIComponents/Pod/Frameworks/iOSKruxLibUniversal.framework'
...
# Univision
s.dependency 'UNFeedSyn', '0.0.79'
s.dependency 'UNVideoPlayer', '0.7.5'

s.dependency 'UNContentDetails', '0.9.12'
...
s.dependency 'UNContentAds', '1.0.1'
