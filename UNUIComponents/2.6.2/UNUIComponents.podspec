Pod::Spec.new do |s|
  ...
  s.vendored_libraries = 'UNUIComponents/Pod/Frameworks/comScore/libcomScore.a', 'UNUIComponents/Pod/Frameworks/comScore/libAdapterFacebook.a'
...
# Univision
  ...
  s.dependency 'UNVideoPlayer', '0.6.5'
  s.dependency 'UNContentDetails', '0.7.9'
  s.dependency 'ULAdobeAuthenticator', '1.6.0'
...
# 3rd Party
  ...
  s.dependency 'Google-Mobile-Ads-SDK', '7.10.1'
  s.dependency 'MMDrawerController', '0.6.0'
  s.dependency 'UrbanAirship-iOS-SDK', '7.2.2'
