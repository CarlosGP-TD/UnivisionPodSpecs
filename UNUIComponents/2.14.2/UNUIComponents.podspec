...
s.vendored_frameworks = 'UNUIComponents/Pod/Frameworks/iOSKruxLibUniversal.framework'
...
s.frameworks = 'UIKit', 'QuartzCore', 'CoreLocation', 'Security', 'WebKit', 'AdSupport', 'AudioToolbox', 'AVFoundation', 'CoreGraphics', 'CoreMedia', 'CoreTelephony', 'EventKit', 'EventKitUI', 'MediaPlayer', 'MessageUI', 'StoreKit', 'SystemConfiguration'
...
s.dependency 'UNContentDetails', '0.9.27'
s.dependency 'ULAdobeAuthenticator', '2.4.1'
s.dependency 'DFComponentsFramework', '~> 0.1.14'
s.dependency 'DFBrowserViewController', '1.0.1'
s.dependency 'UNComScore', '0.1.2'
s.dependency 'ULAdManager/DFP', '0.5.7'
s.dependency 'UNContentAds', '1.0.6'
s.dependency 'UNVideoAds', '1.1.6'
