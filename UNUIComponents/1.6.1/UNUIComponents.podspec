Pod::Spec.new do |s|
  ...
  s.vendored_frameworks = 'UNUIComponents/Pod/Frameworks/TealiumLibrary.framework', 'UNUIComponents/Pod/Frameworks/ym.framework', 'UNUIComponents/Pod/Frameworks/BuddyBuildSDK.framework'
...
# Univision
  s.dependency 'UNFeedSyn', '0.0.60'
  s.dependency 'UNVideoPlayer', '0.3.0'
  s.dependency 'UNContentDetails', '0.6.0'
  s.dependency 'ULAdobeAuthenticator', '1.5.1'
