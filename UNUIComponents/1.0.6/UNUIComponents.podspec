Pod::Spec.new do |s|
  ...
  s.vendored_frameworks = 'UNUIComponents/Pod/Classes/Other/TealiumLibrary.framework', 'UNUIComponents/Pod/Classes/Other/ym.framework'
  s.vendored_libraries = 'UNUIComponents/Pod/Classes/Other/comScore/libcomScore.a'
...
# Univision
  s.dependency 'UNFeedSyn', '0.0.58'
  s.dependency 'UNVideoPlayer', '0.0.1'
  s.dependency 'DFComponentsFramework', '~> 0.1.8'
  s.dependency 'DFBrowserViewController', '1.0.0'
  s.dependency 'ULAdobeAuthenticator', '1.4.76'
