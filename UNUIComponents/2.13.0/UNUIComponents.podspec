...
s.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '"${PODS_ROOT}/TwitterCore/iOS" "${PODS_ROOT}/TwitterKit" "UNUIComponents/Pod/Frameworks/"', 'GCC_PREPROCESSOR_DEFINITIONS' => 'COMSCORE_ON=1 NIELSEN_ON=1' }
s.preserve_paths = 'UNUIComponents/Pod/**/*.{framework,a}'

s.vendored_frameworks = 'UNUIComponents/Pod/Frameworks/TealiumLibrary.framework', 'UNUIComponents/Pod/Frameworks/iOSKruxLibUniversal.framework', 'UNUIComponents/Pod/Frameworks/UNIMoatMobileAppKit.framework'
