...
Pod::Spec.new do |s|
  ...
  s.source_files        = 'Code/' + s.name + '/Pod/Classes/**/*.{h,m,mm}'
  s.public_header_files = 'Code/' + s.name + '/Pod/Classes/**/*.h'

  # Include images in the app main bundle
  s.resources = 'Code/' + s.name + '/Pod/Assets/Images.xcassets'

  # Create a "ULOoyalaPlayerResources.bundle" file
  s.resource_bundles = {
    'ULOoyalaPlayerResources' => ['Code/' + s.name + '/Pod/Assets/*.lproj']
  }
  ...
  s.dependency 'ULAnalyticsManager/FSAdditions', '~>1.1.2'
